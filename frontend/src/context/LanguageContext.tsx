...
const en: Dict = {
  ...
  context_placeholder: 'Enter all background information and symbol definitions here. (Optional) Markdown and LaTeX supported',
  ...
  max_review_iters_label: 'Max Review Iters (1–8)',
  steps_label: 'Steps (1–40)',
      reviews_label: 'Reviews (1–24)',  iterations_label: 'Iterations (1–10)',
...
const zh: Dict = {
  ...
  context_placeholder: '在此输入所有背景信息与符号定义，（可选）支持 Markdown、LaTeX',
  ...
  reform_model: 'Reform Model',
  reasoning_effort: 'Reasoning Effort',
  max_review_iters_label: '最大评审迭代次数 (1–8)',
  steps_label: 'Steps (1–40)',
      reviews_label: 'Reviews (1–24)',  iterations_label: 'Iterations (1–10)',
  reformat_conjectures: 'Reformat conjectures',
  theorem_graph_mode: 'Theorem graph mode',
